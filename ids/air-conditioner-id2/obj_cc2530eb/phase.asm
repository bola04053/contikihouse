...
; This file was generated Mon Aug 25 04:16:22 2014
;--------------------------------------------------------
	.module phase
...
;------------------------------------------------------------
;neighbor                  Allocated to stack - sp -11
...
;	../../../../core/net/mac/phase.c:92: e = find_neighbor(list, neighbor);
	...
	inc	r0
	mov	b,@r0
	mov	r0,#_find_neighbor
	mov	r1,#(_find_neighbor >> 8)
	mov	r2,#(_find_neighbor >> 16)
	lcall	__sdcc_banked_call
	mov	r2,dpl
	mov	r3,dph
	mov	r4,b
...
;------------------------------------------------------------
;neighbor                  Allocated to stack - sp -11
;time                      Allocated to stack - sp -13
;mac_status                Allocated to stack - sp -15
;list                      Allocated to stack - sp -5
;e                         Allocated to stack - sp -2
;------------------------------------------------------------
...
;------------------------------------------------------------
;neighbor                  Allocated to stack - sp -15
;cycle_time                Allocated to stack - sp -17
;guard_time                Allocated to stack - sp -19
;mac_callback              Allocated to stack - sp -22
;mac_callback_ptr          Allocated to stack - sp -25
;buf_list                  Allocated to stack - sp -28
;list                      Allocated to registers r5 r6 r7 
;e                         Allocated to stack - sp -9
;wait                      Allocated to registers r4 r5 
;now                       Allocated to stack - sp -6
;expected                  Allocated to registers r6 r7 
;sync                      Allocated to registers r6 r7 
;ctimewait                 Allocated to stack - sp -4
;p                         Allocated to stack - sp -2
