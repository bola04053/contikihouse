...
_num_sensors:
	.ds 1
_process_thread_sensors_process_i_1_107:
	.ds 2
_process_thread_sensors_process_events_1_107:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;prefix                    Allocated to stack - sp -9
...
;i                         Allocated with name '_process_thread_sensors_process_i_1_107'
;events                    Allocated with name '_process_thread_sensors_process_events_1_107'
;------------------------------------------------------------
...
;	../../../../core/lib/sensors.c:111: for(i = 0; sensors[i] != NULL; ++i) {
	mov	dptr,#_process_thread_sensors_process_i_1_107
	clr	a
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	../../../../core/lib/sensors.c:122: events = 0;
	mov	dptr,#_process_thread_sensors_process_events_1_107
	clr	a
	movx	@dptr,a
	clr	a
	inc	dptr
