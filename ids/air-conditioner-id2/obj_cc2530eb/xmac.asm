...
; This file was generated Mon Aug 25 04:16:19 2014
;--------------------------------------------------------
	.module xmac
...
;------------------------------------------------------------
;t0                        Allocated to stack - sp -69
;t                         Allocated to stack - sp -67
;encounter_time            Allocated to registers 
;strobes                   Allocated to registers 
;ret                       Allocated to registers 
;got_strobe_ack            Allocated to stack - sp -65
;got_ack                   Allocated to stack - sp -64
;strobe                    Allocated to stack - sp -63
;strobe_len                Allocated to stack - sp -13
;len                       Allocated to stack - sp -11
;is_broadcast              Allocated to stack - sp -9
;e                         Allocated to stack - sp -7
;packet                    Allocated to stack - sp -4
;is_already_streaming      Allocated to stack - sp -1
...
;	../../../../core/net/mac/xmac.c:785: qsend_packet(sent, ptr);
	...
	mov	dph,r6
	mov	b,r7
	mov	r0,#_qsend_packet
	mov	r1,#(_qsend_packet >> 8)
	mov	r2,#(_qsend_packet >> 16)
	lcall	__sdcc_banked_call
	dec	sp
	dec	sp
	dec	sp
