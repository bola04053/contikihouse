...
; This file was generated Mon Aug 25 04:16:18 2014
;--------------------------------------------------------
	.module cxmac
...
;	../../../../core/net/mac/cxmac.c:276: (void (*)(void *))cpowercycle, NULL);
	mov	r3,#_cpowercycle
	mov	r4,#(_cpowercycle >> 8)
	mov	r5,#(_cpowercycle >> 16)
...
;	../../../../core/net/mac/cxmac.c:301: CSCHEDULE_POWERCYCLE(DEFAULT_ON_TIME);
	mov	dptr,#0x0000
	mov	r0,#_cschedule_powercycle
	mov	r1,#(_cschedule_powercycle >> 8)
	mov	r2,#(_cschedule_powercycle >> 16)
	lcall	__sdcc_banked_call
...
;sloc0                     Allocated to stack - sp -78
;sloc1                     Allocated to stack - sp -77
;------------------------------------------------------------
...
_cxmac_driver:
	...
	.byte _cxmac_init,(_cxmac_init >> 8),(_cxmac_init >> 16)
