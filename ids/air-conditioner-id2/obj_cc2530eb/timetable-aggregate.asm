...
;sloc1                     Allocated to stack - sp -16
...
;sloc6                     Allocated to stack - sp -10
;------------------------------------------------------------
...
;i                         Allocated to stack - sp -74
;j                         Allocated to registers r6 r7 
;t                         Allocated to stack - sp -72
;categories                Allocated to stack - sp -70
;categories_ptr            Allocated to stack - sp -6
;entry                     Allocated to stack - sp -4
;cat                       Allocated to stack - sp -1
;sloc0                     Allocated to stack - sp -94
;sloc1                     Allocated to stack - sp -91
;sloc2                     Allocated to stack - sp -89
;sloc3                     Allocated to stack - sp -87
;sloc4                     Allocated to stack - sp -85
;sloc5                     Allocated to stack - sp -5
;sloc6                     Allocated to stack - sp -82
;sloc7                     Allocated to stack - sp -81
;sloc8                     Allocated to stack - sp -78
;------------------------------------------------------------
