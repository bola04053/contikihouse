...
;------------------------------------------------------------
;symbol                    Allocated to stack - sp -64
;symtab                    Allocated to stack - sp -66
;symtabsize                Allocated to stack - sp -68
;strtab                    Allocated to stack - sp -70
...
;------------------------------------------------------------
;section                   Allocated to stack - sp -86
;size                      Allocated to stack - sp -88
;sectionaddr               Allocated to stack - sp -90
;sectionbase               Allocated to stack - sp -93
;strs                      Allocated to stack - sp -95
;strtab                    Allocated to stack - sp -97
;symtab                    Allocated to stack - sp -99
;symtabsize                Allocated to stack - sp -101
;using_relas               Allocated to stack - sp -102
;fd                        Allocated to stack - sp -81
;rela                      Allocated to stack - sp -64
;rel_size                  Allocated to stack - sp -52
;s                         Allocated to stack - sp -50
...
;------------------------------------------------------------
;symtab                    Allocated to stack - sp -63
;size                      Allocated to stack - sp -65
;strtab                    Allocated to stack - sp -67
;fd                        Allocated to stack - sp -58
;s                         Allocated to stack - sp -45
;a                         Allocated to registers r4 r5 
;name                      Allocated to stack - sp -29
