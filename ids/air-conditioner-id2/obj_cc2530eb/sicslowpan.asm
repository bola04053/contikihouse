...
; This file was generated Mon Aug 25 04:16:48 2014
;--------------------------------------------------------
	.module sicslowpan
...
;------------------------------------------------------------
;rime_destaddr             Allocated to stack - sp -10
...
;------------------------------------------------------------
;ip_len                    Allocated to stack - sp -12
;tmp                       Allocated to stack - sp -4
...
;	../../../../core/net/sicslowpan.c:971: SICSLOWPAN_UDP_BUF->srcport = UIP_HTONS(SICSLOWPAN_UDP_8_BIT_PORT_MIN +
	...
	add	a,#0xf9
	mov	r0,a
	mov	@r0,#(_uip_aligned_buf + 0x0028)
	inc	r0
	mov	@r0,#((_uip_aligned_buf + 0x0028) >> 8)
	mov	a,#0x01
	add	a,r5
	mov	r2,a
	clr	a
...
;dest                      Allocated with name '_output_dest_1_557'
;------------------------------------------------------------
...
;	../../../../core/net/sicslowpan.c:1541: return 0;
	...
	ljmp	00120$
00118$:
;	../../../../core/net/sicslowpan.c:1553: uip_len - uncomp_hdr_len);
	mov	a,sp
	add	a,#0xfd
	mov	r0,a
	mov	a,r3
