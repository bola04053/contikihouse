...
;sloc4                     Allocated to stack - sp -19
;sloc5                     Allocated to stack - sp -17
;------------------------------------------------------------
